    ...
    <div class="jumbotron col-md-10">
        ...
        <?php
         for($i=0; $i< sizeof($wallpapers); $i++){
            ?>
            <figure>
            <a href="<?php echo base_url();?>assets/wallpaper/<?php echo $wallpapers[$i]->titre;?>" class="zoombox"><img src="<?php echo base_url();?>assets/wallpaper/miniatures/<?php echo $wallpapers[$i]->titre;?>" alt="" width="200px" height="150px" /></a>
            </figure><?php
        }
